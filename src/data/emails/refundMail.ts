...
export const refundMail = (subject:string, name:string,amount:number,requestId:string) => {
    return  `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
          ...
          <p>dear ${name}</p>
          <p> you have been refunded &#8358; ${amount} </p>
          <p>  for your failed transaction </p>
          <p> transaction id:   ${requestId} </p>
